...
export const artists: Record<ArtistId, Artist> = {
  jeweler: {
    ...
    theme: 'jeweler',
    works: [
      { id: 'j1', title: 'Кольца «Северное сияние»', src: '/works/kolca.png' },
      { id: 'j2', title: 'Серьги «Листья лотоса»', src: '/works/monsters.png' },
      { id: 'j3', title: 'Серьги «Астрал»', src: '/works/sergi1.png' },
      { id: 'j4', title: 'Кольцо «Змея»', src: '/works/ring_snake.png' },
      { id: 'p5', title: 'Браслет «Звездный»', src: '/works/Braslet.png' },
      { id: 'p6', title: 'Серьги «Листья»', src: '/works/podveska.png' },
      { id: 'p7', title: 'Кулон «Оберег»', src: '/works/kulon.png' },
      { id: 'p8', title: 'Серьги «Конго»', src: '/works/sergi2.png' },
      { id: 'p9', title: 'Серьги «Гранат»', src: '/works/sergi3.png' },
      { id: 'p10', title: 'Серьги «Хризантемы»', src: '/works/sergi_hrizantems.png' },
      { id: 'p11', title: 'Набор «Фантазия»', src: '/works/nabor.png' },
      { id: 'p12', title: 'Подвески «Перья»', src: '/works/podveska2.png' },
    ],
  },
  painter: {
    id: 'painter',
    ...
    theme: 'painter',
    works: [
      { id: 'p1', title: '«Лиса»', src: '/works/fox.png' },
      { id: 'p2', title: '«Одуванчики»', src: '/works/flowers.png' },
      { id: 'p3', title: '«Горы»', src: '/works/Gora.png' },
      { id: 'p4', title: '«Абстракция 1»', src: '/works/abstrakcia.png' },
      { id: 'p5', title: '«Маяк»', src: '/works/moonhouse.png' },
      { id: 'p6', title: '«Волжский завтрак»', src: '/works/Dug.png' },
      { id: 'p7', title: '«Горы»', src: '/works/3gori.png' },
      { id: 'p8', title:  '«Будда»', src: '/works/budda.png' },
      { id: 'p9', title: '«Девочка в красном»', src: '/works/Girl.jpg' },
      { id: 'p10', title: '«Лиса в снегу', src: '/works/FoxSnow.png'},
      { id: 'p11', title: '«Воспоминание»', src: '/works/vospominaniya.png' },
      { id: 'p12', title: '«Красный парус»', src: '/works/parus.png' },
    ],
  },
};